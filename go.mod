...
replace (
	...
	// CosmWasm/wasmd main branch with cosmos-sdk v0.53.4 + IBC-Go v10 support
	// Using main branch because v0.61.x releases are retracted (issue #2386)
	...
	// Local SDK Go package
	github.com/virtengine/virtengine/sdk/go => ./sdk/go

	// Local SDK specs package
	github.com/virtengine/virtengine/sdk/specs => ./sdk/specs
...
require (
	...
	github.com/CosmWasm/wasmd v0.61.7-0.20260126125754-5cc330bcf3d3 // indirect
