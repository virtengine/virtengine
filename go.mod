...
replace (
	...
	// use virtengine fork of cometbft
	github.com/cometbft/cometbft => github.com/virtengine/cometbft v0.38.19-virtengine.1
	// use virtengine fork of cosmos sdk
	github.com/cosmos/cosmos-sdk => github.com/virtengine/cosmos-sdk v0.53.4-virtengine.b.10

	github.com/cosmos/gogoproto => github.com/virtengine/gogoproto v1.7.0-virtengine.2

	// use virtengine version of cosmos ledger api
	github.com/cosmos/ledger-cosmos-go => github.com/virtengine/ledger-go/cosmos v0.16.0
	...
	github.com/zondax/ledger-go => github.com/virtengine/ledger-go v0.16.0
