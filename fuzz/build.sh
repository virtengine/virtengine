...
# Provider daemon fuzz targets - manifest (note: package may have compilation issues)
# These targets are commented out until the package compiles correctly
...
# MFA types fuzz targets (QUALITY-001)
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzFactorTypeFromString fuzz_factor_type_from_string
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzFactorTypeProperties fuzz_factor_type_properties
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzFactorEnrollmentValidate fuzz_factor_enrollment_validate
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzMFAPolicyValidate fuzz_mfa_policy_validate
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzFactorCombinationIsSatisfiedBy fuzz_factor_combination_is_satisfied_by
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzChallengeValidate fuzz_challenge_validate
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzAuthorizationSessionValidate fuzz_authorization_session_validate
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzTrustedDeviceValidate fuzz_trusted_device_validate
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzComputeFactorFingerprint fuzz_compute_factor_fingerprint
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzComputeDeviceFingerprint fuzz_compute_device_fingerprint
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzComputeChallengeID fuzz_compute_challenge_id
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzMsgEnrollFactorValidateBasic fuzz_msg_enroll_factor_validate_basic
compile_native_go_fuzzer github.com/virtengine/virtengine/x/mfa/types FuzzGenesisStateValidate fuzz_mfa_genesis_state_validate

# Enclave types fuzz targets (QUALITY-001)
# These targets are commented out until the enclave package compiles correctly
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzParseSGXDCAPQuoteV3 fuzz_parse_sgx_dcap_quote_v3
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzParseSEVSNPReport fuzz_parse_sev_snp_report
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzAddMeasurementProposalValidateBasic fuzz_add_measurement_proposal_validate_basic
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzRevokeMeasurementProposalValidateBasic fuzz_revoke_measurement_proposal_validate_basic
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzTEETypeValidation fuzz_tee_type_validation
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzEnclaveIdentityValidate fuzz_enclave_identity_validate
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzAttestationValidate fuzz_attestation_validate
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzMeasurementAllowlistEntry fuzz_measurement_allowlist_entry
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzMsgRegisterEnclaveValidateBasic fuzz_msg_register_enclave_validate_basic
# compile_native_go_fuzzer github.com/virtengine/virtengine/x/enclave/types FuzzMsgSubmitAttestationValidateBasic fuzz_msg_submit_attestation_validate_basic
