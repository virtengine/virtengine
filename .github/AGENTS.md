...
| ----------------------------- | ------- | ------------------------------------------------------------------ | ------------------------------- |
| Go                            | 1.26.8  | `ci.yaml`, `quality-gate.yaml`, `security.yaml`, most Go workflows | Set in `GO_VERSION` env var     |
...
| `dr-failover-test.yaml`       | DR failover drill                                          | schedule Sun 06:00 UTC, dispatch                                     | `dr-failover`                                                                                                                                                                            | DR report artifact                            | Go 1.26.8 + Slack/Discord webhooks                          |
...
| `load-test.yaml`             | Load testing                                               | nightly 02:00 UTC, dispatch                                          | `load-test`                                                                                                                                                                              | Load-test artifacts                           | Go 1.26.8                                                   |
...
| `ml-model-verify.yaml`       | ML model validation                                        | push/pr main paths, dispatch                                         | training + inference checks                                                                                                                                                              | Model validation artifacts                    | Go 1.26.8, Python 3.11                                      |
...
| `staging-e2e.yaml`            | Staging E2E                                                | workflow_dispatch, workflow_run from infra                           | `staging-e2e`                                                                                                                                                                            | staging-e2e-logs artifact                     | Go 1.26.8                                                   |
...
| `supply-chain.yaml`          | SLSA + SBOM                                                | push main/mainnet, tags v\*, PR deps, weekly Mon 04:00 UTC, dispatch | provenance + SBOM suite                                                                                                                                                                  | SBOM/provenance bundles                       | Go 1.26.8, cosign/slsa tooling                              |
...
| `GO_VERSION`                  | `ci.yaml`, `security.yaml`, others                | Go toolchain                     | `1.26.8`                               | Update with Go releases                |
...
- Required toolchain: Go 1.26.8, Node 20, pnpm 10.28.2, Python 3.11.
