This is the requirements for reporting a bug on the virtengine project. If you need general
help, please make a post on [our Discourse](https://forum.virtengine.com).
...
Please paste the output of the `virtengine version` command here. If you built from source,
