...
An VirtEngine Provider Daemon may optionally be run, but
...
```sh
KEY_NAME=other PROVIDER_KEY_NAME=validator DSEQ=20 GSEQ=99 OSEQ=500 PRICE=100uve make bid-create
```
