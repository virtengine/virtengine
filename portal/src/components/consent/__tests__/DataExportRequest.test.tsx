...
expectTranslations(['Your data rights', 'Request JSON export', 'Request CSV export']);

describe.each(TEST_LOCALES)('DataExportStatus export (%s)', (locale) => {
  beforeEach(async () => {
  ...
  it('submits a JSON export request', async () => {
