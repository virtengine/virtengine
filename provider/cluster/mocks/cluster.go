...
func (_m *Cluster) Reserve(_a0 types.OrderID, _a1 virtenginetypes.ResourceGroup) (cluster.Reservation, error) {
	ret := _m.Called(_a0, _a1)

	var r0 cluster.Reservation
	if rf, ok := ret.Get(0).(func(types.OrderID, virtenginetypes.ResourceGroup) cluster.Reservation); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(types.OrderID, virtenginetypes.ResourceGroup) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
