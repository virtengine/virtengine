...
func ScrubFixedSize[T any](data *T) {
	...
	//nolint:gosec // G103: Sizeof only used to bound the in-place scrub length.
	...
	//nolint:gosec // G103: pointer conversion required to zero fixed-size sensitive data in place.
