...
func (snapshot Snapshot) validateSubgroups() error {
	...
	if snapshot.SuppressedSubgroupCount > uint64(MaximumSubgroups-len(snapshot.Subgroups)) { //nolint:gosec // G115: validated non-negative counter; bounded by construction
