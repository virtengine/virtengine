...
type RecoveredSinceDowntimeOfLengthRequest struct {
	...
	Downtime Downtime `protobuf:"varint,1,opt,name=downtime,proto3,enum=virtengine.downtimedetector.v1beta1.Downtime" json:"downtime,omitempty" yaml:"downtime"`
...
func (*RecoveredSinceDowntimeOfLengthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b57db877344b22cf, []int{0}
}
...
func (m *RecoveredSinceDowntimeOfLengthRequest) GetDowntime() Downtime {
	if m != nil {
		return m.Downtime
	}
...
func (*RecoveredSinceDowntimeOfLengthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b57db877344b22cf, []int{1}
}
...
func init() {
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthRequest)(nil), "virtengine.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthResponse)(nil), "virtengine.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
}

func init() {
	proto.RegisterFile("virtengine/downtimedetector/v1beta1/query.proto", fileDescriptor_b57db877344b22cf)
}

var fileDescriptor_b57db877344b22cf = []byte{
	// 424 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) RecoveredSinceDowntimeOfLength(ctx context.Context, in *RecoveredSinceDowntimeOfLengthRequest, opts ...grpc.CallOption) (*RecoveredSinceDowntimeOfLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/virtengine.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveredSinceDowntimeOfLength_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/virtengine.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "virtengine.downtimedetector.v1beta1.Query",
	...
	Metadata: "virtengine/downtimedetector/v1beta1/query.proto",
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Downtime |= Downtime(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
