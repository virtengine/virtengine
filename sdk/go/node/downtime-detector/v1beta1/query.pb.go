...
type RecoveredSinceDowntimeOfLengthRequest struct {
	...
	Downtime Downtime `protobuf:"varint,1,opt,name=downtime,proto3,enum=akash.downtimedetector.v1beta1.Downtime" json:"downtime,omitempty" yaml:"downtime"`
...
func (*RecoveredSinceDowntimeOfLengthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf5043ea1e2ef6b2, []int{0}
}
...
func (*RecoveredSinceDowntimeOfLengthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf5043ea1e2ef6b2, []int{1}
}
...
func init() {
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthRequest)(nil), "akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthResponse)(nil), "akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
}

func init() {
	proto.RegisterFile("akash/downtimedetector/v1beta1/query.proto", fileDescriptor_cf5043ea1e2ef6b2)
}

var fileDescriptor_cf5043ea1e2ef6b2 = []byte{
	// 414 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) RecoveredSinceDowntimeOfLength(ctx context.Context, in *RecoveredSinceDowntimeOfLengthRequest, opts ...grpc.CallOption) (*RecoveredSinceDowntimeOfLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/akash.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveredSinceDowntimeOfLength_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akash.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "akash.downtimedetector.v1beta1.Query",
	...
	Metadata: "akash/downtimedetector/v1beta1/query.proto",
}
