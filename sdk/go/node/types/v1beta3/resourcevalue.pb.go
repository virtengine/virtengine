...
// source: virtengine/base/v1beta3/resourcevalue.proto
...
import (
	...
	pkg_akt_dev_go_node_types_sdk "github.com/virtengine/virtengine/sdk/go/node/types/sdk"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type ResourceValue struct {
	Val pkg_akt_dev_go_node_types_sdk.Int `protobuf:"bytes,1,opt,name=val,proto3,customtype=github.com/virtengine/virtengine/sdk/go/node/types/sdk.Int" json:"val"`
}
...
func init() {
	proto.RegisterType((*ResourceValue)(nil), "virtengine.base.v1beta3.ResourceValue")
}

func init() {
	proto.RegisterFile("virtengine/base/v1beta3/resourcevalue.proto", fileDescriptor_a8f01ca02b3f00f6)
}
