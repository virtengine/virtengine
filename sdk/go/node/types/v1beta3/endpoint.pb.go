...
type Endpoint struct {
	Kind           Endpoint_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=virtengine.base.v1beta3.Endpoint_Kind" json:"kind,omitempty"`
...
func init() {
	proto.RegisterEnum("virtengine.base.v1beta3.Endpoint_Kind", Endpoint_Kind_name, Endpoint_Kind_value)
