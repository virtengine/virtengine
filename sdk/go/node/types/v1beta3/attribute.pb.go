...
func init() {
	proto.RegisterType((*Attribute)(nil), "virtengine.base.v1beta3.Attribute")
	proto.RegisterType((*SignedBy)(nil), "virtengine.base.v1beta3.SignedBy")
	proto.RegisterType((*PlacementRequirements)(nil), "virtengine.base.v1beta3.PlacementRequirements")
}

func init() {
	proto.RegisterFile("virtengine/base/v1beta3/attribute.proto", fileDescriptor_616f00266f4f7c96)
}
