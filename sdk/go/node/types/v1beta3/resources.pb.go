...
func init() {
	proto.RegisterType((*Resources)(nil), "virtengine.base.v1beta3.Resources")
}

func init() {
	proto.RegisterFile("virtengine/base/v1beta3/resources.proto", fileDescriptor_4e8008eb7299c34f)
}
