...
const (
	...
	// AUDIT_ACTION_RESPONDED indicates the reported party or the reporter filed a
...
type FraudRespondentRole int32

const (
	// FRAUD_RESPONDENT_ROLE_UNSPECIFIED represents an unspecified respondent role
	FraudRespondentRoleUnspecified FraudRespondentRole = 0
	// FRAUD_RESPONDENT_ROLE_REPORTED_PARTY indicates the party the report was filed against
	FraudRespondentRoleReportedParty FraudRespondentRole = 1
	// FRAUD_RESPONDENT_ROLE_REPORTER indicates the original reporter
	FraudRespondentRoleReporter FraudRespondentRole = 2
)

var FraudRespondentRole_name = map[int32]string{
	0: "FRAUD_RESPONDENT_ROLE_UNSPECIFIED",
	1: "FRAUD_RESPONDENT_ROLE_REPORTED_PARTY",
	2: "FRAUD_RESPONDENT_ROLE_REPORTER",
}

var FraudRespondentRole_value = map[string]int32{
	"FRAUD_RESPONDENT_ROLE_UNSPECIFIED":    0,
	"FRAUD_RESPONDENT_ROLE_REPORTED_PARTY": 1,
	"FRAUD_RESPONDENT_ROLE_REPORTER":       2,
}

func (x FraudRespondentRole) String() string {
	return proto.EnumName(FraudRespondentRole_name, int32(x))
}

func (FraudRespondentRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ece87b2cf387f05d, []int{4}
}
...
type FraudReport struct {
	...
	FinancialCaseId     string `protobuf:"bytes,17,opt,name=financial_case_id,json=financialCaseId,proto3" json:"financial_case_id,omitempty" yaml:"financial_case_id"`
	FinancialCaseStatus string `protobuf:"bytes,18,opt,name=financial_case_status,json=financialCaseStatus,proto3" json:"financial_case_status,omitempty" yaml:"financial_case_status"`
	...
	ResponseCount uint32 `protobuf:"varint,19,opt,name=response_count,json=responseCount,proto3" json:"response_count,omitempty" yaml:"response_count"`
	...
	NoOrderAvailable bool `protobuf:"varint,20,opt,name=no_order_available,json=noOrderAvailable,proto3" json:"no_order_available,omitempty" yaml:"no_order_available"`
}
...
func (m *FraudReport) GetFinancialCaseId() string {
	if m != nil {
...
func (m *FraudReport) GetFinancialCaseStatus() string {
	if m != nil {
...
func (m *FraudReport) GetResponseCount() uint32 {
	if m != nil {
...
func (m *FraudReport) GetNoOrderAvailable() bool {
	if m != nil {
...
type FraudResponse struct {
	...
	Respondent string `protobuf:"bytes,3,opt,name=respondent,proto3" json:"respondent" yaml:"respondent"`
	// Role identifies which side of the report the respondent represents
	Role FraudRespondentRole `protobuf:"varint,4,opt,name=role,proto3,enum=virtengine.fraud.v1.FraudRespondentRole" json:"role" yaml:"role"`
	...
	StatementHash string `protobuf:"bytes,6,opt,name=statement_hash,json=statementHash,proto3" json:"statement_hash" yaml:"statement_hash"`
	// ContentHash is SHA256 over the immutable response fields for integrity
	ContentHash string `protobuf:"bytes,7,opt,name=content_hash,json=contentHash,proto3" json:"content_hash" yaml:"content_hash"`
	// SubmittedAt is when the response was filed
	SubmittedAt time.Time `protobuf:"bytes,8,opt,name=submitted_at,json=submittedAt,proto3,stdtime" json:"submitted_at" yaml:"submitted_at"`
...
func (m *FraudResponse) Reset()         { *m = FraudResponse{} }
func (m *FraudResponse) String() string { return proto.CompactTextString(m) }
func (*FraudResponse) ProtoMessage()    {}
func (*FraudResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ece87b2cf387f05d, []int{2}
}
func (m *FraudResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FraudResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FraudResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FraudResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FraudResponse.Merge(m, src)
}
func (m *FraudResponse) XXX_Size() int {
	return m.Size()
}
func (m *FraudResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_FraudResponse.DiscardUnknown(m)
}

var xxx_messageInfo_FraudResponse proto.InternalMessageInfo

func (m *FraudResponse) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *FraudResponse) GetReportId() string {
	if m != nil {
		return m.ReportId
	}
	return ""
...
func (m *FraudResponse) GetRespondent() string {
	if m != nil {
		return m.Respondent
	}
	return ""
...
func (m *FraudResponse) GetRole() FraudRespondentRole {
	if m != nil {
		return m.Role
	}
...
func (m *FraudResponse) GetEvidence() []EncryptedEvidence {
	if m != nil {
		return m.Evidence
	}
	return nil
...
func (m *FraudResponse) GetStatementHash() string {
	if m != nil {
...
func (m *FraudResponse) GetContentHash() string {
	if m != nil {
		return m.ContentHash
	}
	return ""
...
func (m *FraudResponse) GetSubmittedAt() time.Time {
	if m != nil {
		return m.SubmittedAt
	}
	return time.Time{}
...
func (m *FraudResponse) GetBlockHeight() int64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type ModeratorQueueEntry struct {
	...
	ResponseCount uint32 `protobuf:"varint,6,opt,name=response_count,json=responseCount,proto3" json:"response_count,omitempty" yaml:"response_count"`
}
...
func (m *ModeratorQueueEntry) GetResponseCount() uint32 {
	if m != nil {
		return m.ResponseCount
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("virtengine.fraud.v1.FraudRespondentRole", FraudRespondentRole_name, FraudRespondentRole_value)
	...
	proto.RegisterType((*FraudResponse)(nil), "virtengine.fraud.v1.FraudResponse")
...
var fileDescriptor_ece87b2cf387f05d = []byte{
	...
	,
}
...
func (this *FraudReport) Equal(that interface{}) bool {
	...
	if this.FinancialCaseId != that1.FinancialCaseId {
		return false
	}
	if this.FinancialCaseStatus != that1.FinancialCaseStatus {
		return false
	}
	if this.ResponseCount != that1.ResponseCount {
		return false
	}
	if this.NoOrderAvailable != that1.NoOrderAvailable {
		return false
	}
	return true
}
func (this *FraudResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*FraudResponse)
	if !ok {
		that2, ok := that.(FraudResponse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.StatementHash != that1.StatementHash {
		return false
	}
	if this.ContentHash != that1.ContentHash {
		return false
...
func (m *FraudReport) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ResponseCount != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.ResponseCount))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
...
func (m *FraudResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FraudResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FraudResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	n4, err4 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.SubmittedAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.SubmittedAt):])
	if err4 != nil {
		return 0, err4
	}
	i -= n4
	...
	if len(m.StatementHash) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.StatementHash)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Evidence) > 0 {
...
func (m *ModeratorQueueEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n6, err6 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.QueuedAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.QueuedAt):])
	if err6 != nil {
		return 0, err6
	}
	i -= n6
...
func (m *FraudReport) Size() (n int) {
	...
	if m.ResponseCount != 0 {
		n += 2 + sovTypes(uint64(m.ResponseCount))
	}
	if m.NoOrderAvailable {
		n += 3
	}
...
func (m *FraudResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModeratorQueueEntry) Size() (n int) {
	...
	if m.ResponseCount != 0 {
		n += 1 + sovTypes(uint64(m.ResponseCount))
	}
	return n
}
...
func (m *FraudResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FraudResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FraudResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Role |= FraudRespondentRole(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
