...
type HPCJob struct {
	...
	ReservationId           string                                   `protobuf:"bytes,25,opt,name=reservation_id,json=reservationId,proto3" json:"reservation_id,omitempty" yaml:"reservation_id"`
	AllocationId            string                                   `protobuf:"bytes,26,opt,name=allocation_id,json=allocationId,proto3" json:"allocation_id,omitempty" yaml:"allocation_id"`
	MarketOrderId           string                                   `protobuf:"bytes,27,opt,name=market_order_id,json=marketOrderId,proto3" json:"market_order_id,omitempty" yaml:"market_order_id"`
	MarketBidId             string                                   `protobuf:"bytes,28,opt,name=market_bid_id,json=marketBidId,proto3" json:"market_bid_id,omitempty" yaml:"market_bid_id"`
	MarketLeaseId           string                                   `protobuf:"bytes,29,opt,name=market_lease_id,json=marketLeaseId,proto3" json:"market_lease_id,omitempty" yaml:"market_lease_id"`
}
...
func (m *HPCJob) GetReservationId() string {
	if m != nil {
...
func (m *HPCJob) GetAllocationId() string {
	if m != nil {
...
func (m *HPCJob) GetMarketOrderId() string {
	if m != nil {
...
func (m *HPCJob) GetMarketBidId() string {
	if m != nil {
...
func (m *HPCJob) GetMarketLeaseId() string {
	if m != nil {
...
type ClusterCandidate struct {
	...
	PriorityScore       string `protobuf:"bytes,10,opt,name=priority_score,json=priorityScore,proto3" json:"priority_score,omitempty" yaml:"priority_score"`
	FairShareScore      string `protobuf:"bytes,11,opt,name=fair_share_score,json=fairShareScore,proto3" json:"fair_share_score,omitempty" yaml:"fair_share_score"`
	AgeScore            string `protobuf:"bytes,12,opt,name=age_score,json=ageScore,proto3" json:"age_score,omitempty" yaml:"age_score"`
	JobSizeScore        string `protobuf:"bytes,13,opt,name=job_size_score,json=jobSizeScore,proto3" json:"job_size_score,omitempty" yaml:"job_size_score"`
	PartitionScore      string `protobuf:"bytes,14,opt,name=partition_score,json=partitionScore,proto3" json:"partition_score,omitempty" yaml:"partition_score"`
	PreemptionPossible  bool   `protobuf:"varint,15,opt,name=preemption_possible,json=preemptionPossible,proto3" json:"preemption_possible,omitempty" yaml:"preemption_possible"`
	QuotaBurstUsed      bool   `protobuf:"varint,16,opt,name=quota_burst_used,json=quotaBurstUsed,proto3" json:"quota_burst_used,omitempty" yaml:"quota_burst_used"`
}
...
func (m *ClusterCandidate) GetPriorityScore() string {
	if m != nil {
...
func (m *ClusterCandidate) GetFairShareScore() string {
	if m != nil {
		return m.FairShareScore
	}
	return ""
}

func (m *ClusterCandidate) GetAgeScore() string {
	if m != nil {
		return m.AgeScore
	}
	return ""
...
func (m *ClusterCandidate) GetJobSizeScore() string {
	if m != nil {
		return m.JobSizeScore
	}
	return ""
}

func (m *ClusterCandidate) GetPartitionScore() string {
	if m != nil {
		return m.PartitionScore
	}
	return ""
}

func (m *ClusterCandidate) GetPreemptionPossible() bool {
	if m != nil {
		return m.PreemptionPossible
	}
	return false
}

func (m *ClusterCandidate) GetQuotaBurstUsed() bool {
	if m != nil {
		return m.QuotaBurstUsed
	}
	return false
}
...
type SchedulingDecision struct {
	...
	PriorityScore         string             `protobuf:"bytes,13,opt,name=priority_score,json=priorityScore,proto3" json:"priority_score,omitempty" yaml:"priority_score"`
	FairShareScore        string             `protobuf:"bytes,14,opt,name=fair_share_score,json=fairShareScore,proto3" json:"fair_share_score,omitempty" yaml:"fair_share_score"`
	AgeScore              string             `protobuf:"bytes,15,opt,name=age_score,json=ageScore,proto3" json:"age_score,omitempty" yaml:"age_score"`
	JobSizeScore          string             `protobuf:"bytes,16,opt,name=job_size_score,json=jobSizeScore,proto3" json:"job_size_score,omitempty" yaml:"job_size_score"`
	PartitionScore        string             `protobuf:"bytes,17,opt,name=partition_score,json=partitionScore,proto3" json:"partition_score,omitempty" yaml:"partition_score"`
	PreemptionPlanned     bool               `protobuf:"varint,18,opt,name=preemption_planned,json=preemptionPlanned,proto3" json:"preemption_planned,omitempty" yaml:"preemption_planned"`
	PreemptedJobIds       []string           `protobuf:"bytes,19,rep,name=preempted_job_ids,json=preemptedJobIds,proto3" json:"preempted_job_ids,omitempty" yaml:"preempted_job_ids"`
	BackfillUsed          bool               `protobuf:"varint,20,opt,name=backfill_used,json=backfillUsed,proto3" json:"backfill_used,omitempty" yaml:"backfill_used"`
	BackfillWindowSeconds int64              `protobuf:"varint,21,opt,name=backfill_window_seconds,json=backfillWindowSeconds,proto3" json:"backfill_window_seconds,omitempty" yaml:"backfill_window_seconds"`
	QuotaBurstUsed        bool               `protobuf:"varint,22,opt,name=quota_burst_used,json=quotaBurstUsed,proto3" json:"quota_burst_used,omitempty" yaml:"quota_burst_used"`
	QuotaReason           string             `protobuf:"bytes,23,opt,name=quota_reason,json=quotaReason,proto3" json:"quota_reason,omitempty" yaml:"quota_reason"`
}
...
func (m *SchedulingDecision) GetPriorityScore() string {
	if m != nil {
		return m.PriorityScore
	}
	return ""
...
func (m *SchedulingDecision) GetFairShareScore() string {
	if m != nil {
		return m.FairShareScore
	}
	return ""
...
func (m *SchedulingDecision) GetAgeScore() string {
	if m != nil {
		return m.AgeScore
	}
	return ""
...
func (m *SchedulingDecision) GetJobSizeScore() string {
	if m != nil {
		return m.JobSizeScore
	}
	return ""
...
func (m *SchedulingDecision) GetPartitionScore() string {
	if m != nil {
		return m.PartitionScore
	}
	return ""
...
func (m *SchedulingDecision) GetPreemptionPlanned() bool {
	if m != nil {
		return m.PreemptionPlanned
	}
	return false
}

func (m *SchedulingDecision) GetPreemptedJobIds() []string {
	if m != nil {
...
func (m *SchedulingDecision) GetBackfillUsed() bool {
	if m != nil {
		return m.BackfillUsed
	}
	return false
}

func (m *SchedulingDecision) GetBackfillWindowSeconds() int64 {
	if m != nil {
		return m.BackfillWindowSeconds
	}
	return 0
}

func (m *SchedulingDecision) GetQuotaBurstUsed() bool {
	if m != nil {
		return m.QuotaBurstUsed
	}
	return false
...
func (m *SchedulingDecision) GetQuotaReason() string {
	if m != nil {
		return m.QuotaReason
	}
	return ""
}
...
type SchedulingMetrics struct {
	...
	TotalDecisions    uint64    `protobuf:"varint,3,opt,name=total_decisions,json=totalDecisions,proto3" json:"total_decisions" yaml:"total_decisions"`
	PreemptionPlanned uint64    `protobuf:"varint,4,opt,name=preemption_planned,json=preemptionPlanned,proto3" json:"preemption_planned" yaml:"preemption_planned"`
	BackfillUsed      uint64    `protobuf:"varint,5,opt,name=backfill_used,json=backfillUsed,proto3" json:"backfill_used" yaml:"backfill_used"`
	QuotaBurstUsed    uint64    `protobuf:"varint,6,opt,name=quota_burst_used,json=quotaBurstUsed,proto3" json:"quota_burst_used" yaml:"quota_burst_used"`
	QuotaDenied       uint64    `protobuf:"varint,7,opt,name=quota_denied,json=quotaDenied,proto3" json:"quota_denied" yaml:"quota_denied"`
	AvgLatencyScore   string    `protobuf:"bytes,8,opt,name=avg_latency_score,json=avgLatencyScore,proto3" json:"avg_latency_score" yaml:"avg_latency_score"`
	AvgCapacityScore  string    `protobuf:"bytes,9,opt,name=avg_capacity_score,json=avgCapacityScore,proto3" json:"avg_capacity_score" yaml:"avg_capacity_score"`
	AvgCombinedScore  string    `protobuf:"bytes,10,opt,name=avg_combined_score,json=avgCombinedScore,proto3" json:"avg_combined_score" yaml:"avg_combined_score"`
	AvgPriorityScore  string    `protobuf:"bytes,11,opt,name=avg_priority_score,json=avgPriorityScore,proto3" json:"avg_priority_score" yaml:"avg_priority_score"`
	AvgFairShareScore string    `protobuf:"bytes,12,opt,name=avg_fair_share_score,json=avgFairShareScore,proto3" json:"avg_fair_share_score" yaml:"avg_fair_share_score"`
	AvgAgeScore       string    `protobuf:"bytes,13,opt,name=avg_age_score,json=avgAgeScore,proto3" json:"avg_age_score" yaml:"avg_age_score"`
	AvgJobSizeScore   string    `protobuf:"bytes,14,opt,name=avg_job_size_score,json=avgJobSizeScore,proto3" json:"avg_job_size_score" yaml:"avg_job_size_score"`
	AvgPartitionScore string    `protobuf:"bytes,15,opt,name=avg_partition_score,json=avgPartitionScore,proto3" json:"avg_partition_score" yaml:"avg_partition_score"`
	LastDecisionAt    time.Time `protobuf:"bytes,16,opt,name=last_decision_at,json=lastDecisionAt,proto3,stdtime" json:"last_decision_at" yaml:"last_decision_at"`
	BlockHeight       int64     `protobuf:"varint,17,opt,name=block_height,json=blockHeight,proto3" json:"block_height" yaml:"block_height"`
}

func (m *SchedulingMetrics) Reset()         { *m = SchedulingMetrics{} }
func (m *SchedulingMetrics) String() string { return proto.CompactTextString(m) }
...
func (m *SchedulingMetrics) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SchedulingMetrics) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SchedulingMetrics.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SchedulingMetrics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SchedulingMetrics.Merge(m, src)
}
func (m *SchedulingMetrics) XXX_Size() int {
	return m.Size()
}
func (m *SchedulingMetrics) XXX_DiscardUnknown() {
	xxx_messageInfo_SchedulingMetrics.DiscardUnknown(m)
}

var xxx_messageInfo_SchedulingMetrics proto.InternalMessageInfo

func (m *SchedulingMetrics) GetClusterId() string {
	if m != nil {
		return m.ClusterId
	}
	return ""
...
func (m *SchedulingMetrics) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *SchedulingMetrics) GetTotalDecisions() uint64 {
	if m != nil {
...
func (m *SchedulingMetrics) GetPreemptionPlanned() uint64 {
	if m != nil {
		return m.PreemptionPlanned
	}
	return 0
...
func (m *SchedulingMetrics) GetBackfillUsed() uint64 {
	if m != nil {
		return m.BackfillUsed
	}
	return 0
...
func (m *SchedulingMetrics) GetQuotaBurstUsed() uint64 {
	if m != nil {
		return m.QuotaBurstUsed
	}
	return 0
...
func (m *SchedulingMetrics) GetQuotaDenied() uint64 {
	if m != nil {
		return m.QuotaDenied
	}
	return 0
}

func (m *SchedulingMetrics) GetAvgLatencyScore() string {
	if m != nil {
		return m.AvgLatencyScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgCapacityScore() string {
	if m != nil {
		return m.AvgCapacityScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgCombinedScore() string {
	if m != nil {
		return m.AvgCombinedScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgPriorityScore() string {
	if m != nil {
		return m.AvgPriorityScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgFairShareScore() string {
	if m != nil {
		return m.AvgFairShareScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgAgeScore() string {
	if m != nil {
		return m.AvgAgeScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgJobSizeScore() string {
	if m != nil {
		return m.AvgJobSizeScore
	}
	return ""
}

func (m *SchedulingMetrics) GetAvgPartitionScore() string {
	if m != nil {
		return m.AvgPartitionScore
	}
	return ""
}

func (m *SchedulingMetrics) GetLastDecisionAt() time.Time {
	if m != nil {
		return m.LastDecisionAt
	}
	return time.Time{}
}

func (m *SchedulingMetrics) GetBlockHeight() int64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type HPCDispute struct {
	...
	FinancialCaseId     string        `protobuf:"bytes,14,opt,name=financial_case_id,json=financialCaseId,proto3" json:"financial_case_id,omitempty" yaml:"financial_case_id"`
	FinancialCaseStatus string        `protobuf:"bytes,15,opt,name=financial_case_status,json=financialCaseStatus,proto3" json:"financial_case_status,omitempty" yaml:"financial_case_status"`
}
...
func (m *HPCDispute) GetFinancialCaseId() string {
	if m != nil {
...
func (m *HPCDispute) GetFinancialCaseStatus() string {
	if m != nil {
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_fa86d97942c2f91a, []int{29}
}
...
func init() {
	...
	proto.RegisterType((*SchedulingMetrics)(nil), "virtengine.hpc.v1.SchedulingMetrics")
...
var fileDescriptor_fa86d97942c2f91a = []byte{
	...
	,
}
...
func (m *ClusterCandidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PartitionScore) > 0 {
		i -= len(m.PartitionScore)
		copy(dAtA[i:], m.PartitionScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PartitionScore)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.JobSizeScore) > 0 {
		i -= len(m.JobSizeScore)
		copy(dAtA[i:], m.JobSizeScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.JobSizeScore)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.AgeScore) > 0 {
		i -= len(m.AgeScore)
		copy(dAtA[i:], m.AgeScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AgeScore)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.FairShareScore) > 0 {
		i -= len(m.FairShareScore)
		copy(dAtA[i:], m.FairShareScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.FairShareScore)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.PriorityScore) > 0 {
		i -= len(m.PriorityScore)
		copy(dAtA[i:], m.PriorityScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PriorityScore)))
		i--
		dAtA[i] = 0x52
	}
...
func (m *SchedulingDecision) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.QuotaReason) > 0 {
		i -= len(m.QuotaReason)
		copy(dAtA[i:], m.QuotaReason)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.QuotaReason)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xba
	...
	if m.BackfillWindowSeconds != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.BackfillWindowSeconds))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	...
	if len(m.PreemptedJobIds) > 0 {
		for iNdEx := len(m.PreemptedJobIds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.PreemptedJobIds[iNdEx])
			copy(dAtA[i:], m.PreemptedJobIds[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.PreemptedJobIds[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x9a
...
func (m *SchedulingMetrics) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SchedulingMetrics) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SchedulingMetrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	n28, err28 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.LastDecisionAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.LastDecisionAt):])
	if err28 != nil {
		return 0, err28
	}
	i -= n28
	...
	i--
	dAtA[i] = 0x82
	if len(m.AvgPartitionScore) > 0 {
		i -= len(m.AvgPartitionScore)
		copy(dAtA[i:], m.AvgPartitionScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgPartitionScore)))
		i--
		dAtA[i] = 0x7a
	}
	if len(m.AvgJobSizeScore) > 0 {
		i -= len(m.AvgJobSizeScore)
		copy(dAtA[i:], m.AvgJobSizeScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgJobSizeScore)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.AvgAgeScore) > 0 {
		i -= len(m.AvgAgeScore)
		copy(dAtA[i:], m.AvgAgeScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgAgeScore)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.AvgFairShareScore) > 0 {
		i -= len(m.AvgFairShareScore)
		copy(dAtA[i:], m.AvgFairShareScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgFairShareScore)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.AvgPriorityScore) > 0 {
		i -= len(m.AvgPriorityScore)
		copy(dAtA[i:], m.AvgPriorityScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgPriorityScore)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.AvgCombinedScore) > 0 {
		i -= len(m.AvgCombinedScore)
		copy(dAtA[i:], m.AvgCombinedScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgCombinedScore)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.AvgCapacityScore) > 0 {
		i -= len(m.AvgCapacityScore)
		copy(dAtA[i:], m.AvgCapacityScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgCapacityScore)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.AvgLatencyScore) > 0 {
		i -= len(m.AvgLatencyScore)
		copy(dAtA[i:], m.AvgLatencyScore)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AvgLatencyScore)))
		i--
		dAtA[i] = 0x42
	}
	if m.QuotaDenied != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.QuotaDenied))
		i--
		dAtA[i] = 0x38
	}
	if m.QuotaBurstUsed != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.QuotaBurstUsed))
		i--
		dAtA[i] = 0x30
	}
	if m.BackfillUsed != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.BackfillUsed))
		i--
		dAtA[i] = 0x28
	}
	if m.PreemptionPlanned != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.PreemptionPlanned))
		i--
		dAtA[i] = 0x20
	}
	if m.TotalDecisions != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.TotalDecisions))
		i--
		dAtA[i] = 0x18
	}
	if len(m.QueueName) > 0 {
...
func (m *HPCRewardRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n29, err29 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.IssuedAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.IssuedAt):])
	if err29 != nil {
		return 0, err29
	}
	i -= n29
...
func (m *HPCDispute) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FinancialCaseStatus) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.FinancialCaseStatus)))
		i--
		dAtA[i] = 0x7a
	}
...
func (m *ClusterCandidate) Size() (n int) {
	...
	l = len(m.PriorityScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.FairShareScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AgeScore)
	...
	l = len(m.JobSizeScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.PartitionScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.PreemptionPossible {
...
func (m *SchedulingDecision) Size() (n int) {
	...
	if len(m.PreemptedJobIds) > 0 {
		for _, s := range m.PreemptedJobIds {
			l = len(s)
			n += 2 + l + sovTypes(uint64(l))
		}
	}
	...
	if m.BackfillWindowSeconds != 0 {
		n += 2 + sovTypes(uint64(m.BackfillWindowSeconds))
	}
	if m.QuotaBurstUsed {
		n += 3
	}
...
func (m *SchedulingMetrics) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TotalDecisions != 0 {
		n += 1 + sovTypes(uint64(m.TotalDecisions))
	}
	if m.PreemptionPlanned != 0 {
		n += 1 + sovTypes(uint64(m.PreemptionPlanned))
	}
	if m.BackfillUsed != 0 {
		n += 1 + sovTypes(uint64(m.BackfillUsed))
	}
	if m.QuotaBurstUsed != 0 {
		n += 1 + sovTypes(uint64(m.QuotaBurstUsed))
	}
	if m.QuotaDenied != 0 {
		n += 1 + sovTypes(uint64(m.QuotaDenied))
	}
	l = len(m.AvgLatencyScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AvgCapacityScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AvgCombinedScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AvgPriorityScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AvgFairShareScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AvgAgeScore)
	...
	l = len(m.AvgJobSizeScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.AvgPartitionScore)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = github_com_cosmos_gogoproto_types.SizeOfStdTime(m.LastDecisionAt)
	n += 2 + l + sovTypes(uint64(l))
	if m.BlockHeight != 0 {
		n += 2 + sovTypes(uint64(m.BlockHeight))
	}
...
func (m *ClusterCandidate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.PriorityScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FairShareScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FairShareScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
			...
			m.AgeScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobSizeScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.JobSizeScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartitionScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PartitionScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreemptionPossible", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreemptionPossible = bool(v != 0)
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuotaBurstUsed", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *SchedulingDecision) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreemptionPlanned", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreemptionPlanned = bool(v != 0)
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreemptedJobIds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreemptedJobIds = append(m.PreemptedJobIds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BackfillUsed", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BackfillUsed = bool(v != 0)
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BackfillWindowSeconds", wireType)
			}
			m.BackfillWindowSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BackfillWindowSeconds |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuotaReason", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QuotaReason = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *SchedulingMetrics) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SchedulingMetrics: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SchedulingMetrics: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDecisions", wireType)
			}
			m.TotalDecisions = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalDecisions |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PreemptionPlanned |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BackfillUsed |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QuotaBurstUsed |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuotaDenied", wireType)
			}
			m.QuotaDenied = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QuotaDenied |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgLatencyScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgLatencyScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgCapacityScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgCapacityScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgCombinedScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgCombinedScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgPriorityScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgPriorityScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgFairShareScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgFairShareScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgAgeScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgAgeScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgJobSizeScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgJobSizeScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgPartitionScore", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvgPartitionScore = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastDecisionAt", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_cosmos_gogoproto_types.StdTimeUnmarshal(&m.LastDecisionAt, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 17:
