...
func init() {
	proto.RegisterType((*QueryAccountsRequest)(nil), "virtengine.escrow.v1beta3.QueryAccountsRequest")
	proto.RegisterType((*QueryAccountsResponse)(nil), "virtengine.escrow.v1beta3.QueryAccountsResponse")
	proto.RegisterType((*QueryPaymentsRequest)(nil), "virtengine.escrow.v1beta3.QueryPaymentsRequest")
...
func (c *queryClient) Accounts(ctx context.Context, in *QueryAccountsRequest, opts ...grpc.CallOption) (*QueryAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/virtengine.escrow.v1beta3.Query/Accounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Payments(ctx context.Context, in *QueryPaymentsRequest, opts ...grpc.CallOption) (*QueryPaymentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/virtengine.escrow.v1beta3.Query/Payments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Accounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/virtengine.escrow.v1beta3.Query/Accounts",
	}
...
func _Query_Payments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/virtengine.escrow.v1beta3.Query/Payments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "virtengine.escrow.v1beta3.Query",
	...
	Metadata: "virtengine/escrow/v1beta3/query.proto",
}
