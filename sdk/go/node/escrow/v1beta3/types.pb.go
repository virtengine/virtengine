...
type Account struct {
	...
	State Account_State `protobuf:"varint,3,opt,name=state,proto3,enum=virtengine.escrow.v1beta3.Account_State" json:"state" yaml:"state"`
...
type FractionalPayment struct {
	...
	State     FractionalPayment_State `protobuf:"varint,4,opt,name=state,proto3,enum=virtengine.escrow.v1beta3.FractionalPayment_State" json:"state" yaml:"state"`
...
func init() {
	proto.RegisterEnum("virtengine.escrow.v1beta3.Account_State", Account_State_name, Account_State_value)
	proto.RegisterEnum("virtengine.escrow.v1beta3.FractionalPayment_State", FractionalPayment_State_name, FractionalPayment_State_value)
	proto.RegisterType((*AccountID)(nil), "virtengine.escrow.v1beta3.AccountID")
	proto.RegisterType((*Account)(nil), "virtengine.escrow.v1beta3.Account")
	proto.RegisterType((*FractionalPayment)(nil), "virtengine.escrow.v1beta3.FractionalPayment")
}

func init() { proto.RegisterFile("virtengine/escrow/v1beta3/types.proto", fileDescriptor_c4875611bf6739ee) }
