...
type Order struct {
	...
	State     Order_State       `protobuf:"varint,2,opt,name=state,proto3,enum=virtengine.market.v1beta4.Order_State" json:"state" yaml:"state"`
...
func init() {
	proto.RegisterEnum("virtengine.market.v1beta4.Order_State", Order_State_name, Order_State_value)
	proto.RegisterType((*OrderID)(nil), "virtengine.market.v1beta4.OrderID")
	proto.RegisterType((*Order)(nil), "virtengine.market.v1beta4.Order")
