...
type Bid struct {
	BidID          BidID          `protobuf:"bytes,1,opt,name=bid_id,json=bidId,proto3" json:"id" yaml:"id"`
	State          Bid_State      `protobuf:"varint,2,opt,name=state,proto3,enum=virtengine.market.v1beta4.Bid_State" json:"state" yaml:"state"`
	Price          types.DecCoin  `protobuf:"bytes,3,opt,name=price,proto3" json:"price" yaml:"price"`
...
func init() {
	proto.RegisterEnum("virtengine.market.v1beta4.Bid_State", Bid_State_name, Bid_State_value)
	proto.RegisterType((*ResourceOffer)(nil), "virtengine.market.v1beta4.ResourceOffer")
	proto.RegisterType((*MsgCreateBid)(nil), "virtengine.market.v1beta4.MsgCreateBid")
	proto.RegisterType((*MsgCreateBidResponse)(nil), "virtengine.market.v1beta4.MsgCreateBidResponse")
	proto.RegisterType((*MsgCloseBid)(nil), "virtengine.market.v1beta4.MsgCloseBid")
	proto.RegisterType((*MsgCloseBidResponse)(nil), "virtengine.market.v1beta4.MsgCloseBidResponse")
	proto.RegisterType((*BidID)(nil), "virtengine.market.v1beta4.BidID")
	proto.RegisterType((*Bid)(nil), "virtengine.market.v1beta4.Bid")
