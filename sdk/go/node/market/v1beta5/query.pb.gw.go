...
var (
	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"virtengine", "market", "v1beta5", "orders", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"virtengine", "market", "v1beta5", "orders", "info"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Bids_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"virtengine", "market", "v1beta5", "bids", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Bid_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"virtengine", "market", "v1beta5", "bids", "info"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Leases_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"virtengine", "market", "v1beta5", "leases", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Lease_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"virtengine", "market", "v1beta5", "leases", "info"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"virtengine", "market", "v1beta5", "params"}, "", runtime.AssumeColonVerbOpt(false)))
)
