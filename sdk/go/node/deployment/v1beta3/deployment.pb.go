...
type Deployment struct {
	...
	State        Deployment_State `protobuf:"varint,2,opt,name=state,proto3,enum=virtengine.deployment.v1beta3.Deployment_State" json:"state" yaml:"state"`
...
func init() {
	proto.RegisterEnum("virtengine.deployment.v1beta3.Deployment_State", Deployment_State_name, Deployment_State_value)
	proto.RegisterType((*DeploymentID)(nil), "virtengine.deployment.v1beta3.DeploymentID")
	proto.RegisterType((*Deployment)(nil), "virtengine.deployment.v1beta3.Deployment")
	proto.RegisterType((*DeploymentFilters)(nil), "virtengine.deployment.v1beta3.DeploymentFilters")
}

func init() {
	proto.RegisterFile("virtengine/deployment/v1beta3/deployment.proto", fileDescriptor_16b7a55888f623cc)
}
