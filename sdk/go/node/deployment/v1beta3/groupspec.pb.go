...
func init() {
	proto.RegisterType((*GroupSpec)(nil), "virtengine.deployment.v1beta3.GroupSpec")
}

func init() {
	proto.RegisterFile("virtengine/deployment/v1beta3/groupspec.proto", fileDescriptor_8f47a9fa0e046026)
}
