...
func init() {
	proto.RegisterType((*GroupID)(nil), "virtengine.deployment.v1beta3.GroupID")
}

func init() {
	proto.RegisterFile("virtengine/deployment/v1beta3/groupid.proto", fileDescriptor_9f2340787793cb10)
}
