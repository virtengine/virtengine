...
func init() {
	proto.RegisterType((*ResourceUnit)(nil), "virtengine.deployment.v1beta3.ResourceUnit")
}

func init() {
	proto.RegisterFile("virtengine/deployment/v1beta3/resourceunit.proto", fileDescriptor_fb431767d5aa2e0f)
}
