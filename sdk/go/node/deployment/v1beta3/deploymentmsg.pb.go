...
func init() {
	proto.RegisterType((*MsgCreateDeployment)(nil), "virtengine.deployment.v1beta3.MsgCreateDeployment")
	proto.RegisterType((*MsgCreateDeploymentResponse)(nil), "virtengine.deployment.v1beta3.MsgCreateDeploymentResponse")
	proto.RegisterType((*MsgDepositDeployment)(nil), "virtengine.deployment.v1beta3.MsgDepositDeployment")
	proto.RegisterType((*MsgDepositDeploymentResponse)(nil), "virtengine.deployment.v1beta3.MsgDepositDeploymentResponse")
	proto.RegisterType((*MsgUpdateDeployment)(nil), "virtengine.deployment.v1beta3.MsgUpdateDeployment")
	proto.RegisterType((*MsgUpdateDeploymentResponse)(nil), "virtengine.deployment.v1beta3.MsgUpdateDeploymentResponse")
	proto.RegisterType((*MsgCloseDeployment)(nil), "virtengine.deployment.v1beta3.MsgCloseDeployment")
	proto.RegisterType((*MsgCloseDeploymentResponse)(nil), "virtengine.deployment.v1beta3.MsgCloseDeploymentResponse")
}

func init() {
	proto.RegisterFile("virtengine/deployment/v1beta3/deploymentmsg.proto", fileDescriptor_f364faefc2dcd8b7)
}
