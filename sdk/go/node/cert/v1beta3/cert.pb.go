...
type Certificate struct {
	State  Certificate_State `protobuf:"varint,2,opt,name=state,proto3,enum=virtengine.cert.v1beta3.Certificate_State" json:"state" yaml:"state"`
...
func init() {
	proto.RegisterEnum("virtengine.cert.v1beta3.Certificate_State", Certificate_State_name, Certificate_State_value)
	proto.RegisterType((*CertificateID)(nil), "virtengine.cert.v1beta3.CertificateID")
	proto.RegisterType((*Certificate)(nil), "virtengine.cert.v1beta3.Certificate")
	proto.RegisterType((*CertificateFilter)(nil), "virtengine.cert.v1beta3.CertificateFilter")
	proto.RegisterType((*MsgCreateCertificate)(nil), "virtengine.cert.v1beta3.MsgCreateCertificate")
	proto.RegisterType((*MsgCreateCertificateResponse)(nil), "virtengine.cert.v1beta3.MsgCreateCertificateResponse")
	proto.RegisterType((*MsgRevokeCertificate)(nil), "virtengine.cert.v1beta3.MsgRevokeCertificate")
