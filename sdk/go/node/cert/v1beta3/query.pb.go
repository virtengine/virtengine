...
// source: virtengine/cert/v1beta3/query.proto
...
func init() {
	proto.RegisterType((*CertificateResponse)(nil), "virtengine.cert.v1beta3.CertificateResponse")
	proto.RegisterType((*QueryCertificatesRequest)(nil), "virtengine.cert.v1beta3.QueryCertificatesRequest")
