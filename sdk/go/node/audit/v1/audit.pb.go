...
import (
	...
	math "math"
	math_bits "math/bits"
	pkg_akt_dev_go_node_types_attributes_v1 "github.com/virtengine/virtengine/sdk/go/node/types/attributes/v1"
...
type AuditedProvider struct {
	...
	Attributes pkg_akt_dev_go_node_types_attributes_v1.Attributes `protobuf:"bytes,4,rep,name=attributes,proto3,castrepeated=github.com/virtengine/virtengine/sdk/go/node/types/attributes/v1.Attributes" json:"attributes" yaml:"attributes"`
}
...
type AuditedAttributesStore struct {
	// Attributes holds a list of key-value pairs of provider attributes.
	// Attributes are arbitrary values that a provider exposes.
	Attributes pkg_akt_dev_go_node_types_attributes_v1.Attributes `protobuf:"bytes,1,rep,name=attributes,proto3,castrepeated=github.com/virtengine/virtengine/sdk/go/node/types/attributes/v1.Attributes" json:"attributes" yaml:"attributes"`
}
