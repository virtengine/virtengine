...
var (
	pattern_Query_AllProvidersAttributes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3, 2, 4}, []string{"virtengine", "audit", "v1", "attributes", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProviderAttributes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"virtengine", "audit", "v1", "attributes", "owner", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProviderAuditorAttributes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"virtengine", "audit", "v1", "attributes", "auditor", "owner"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AuditorAttributes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"virtengine", "provider", "v1", "auditor", "list"}, "", runtime.AssumeColonVerbOpt(false)))
)
