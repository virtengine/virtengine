...
const (
	...
	FlagNoTokenTransfer           = "no-token-transfer" /* #nosec G101 -- #nosec G101: CLI flag name, not a credential */ //nolint:gosec
	...
	FlagWasmSkipWasmVMVersionCheck = "wasm.skip_wasmvm_version_check" /* #nosec G101 -- #nosec G101: CLI flag name, not a credential */ //nolint:gosec
)
