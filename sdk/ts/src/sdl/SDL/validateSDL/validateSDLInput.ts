...
var pattern7 = new RegExp("^(uve|ibc/.*)$", "u");
                        ...
                        if (data34.denom !== void 0) {
                          ...
                          if (typeof data36 === "string") {
                            if (!pattern7.test(data36)) {
                              const err83 = { instancePath: instancePath + "/profiles/placement/" + key17.replace(/~/g, "~0").replace(/\//g, "~1") + "/pricing/" + key19.replace(/~/g, "~0").replace(/\//g, "~1") + "/denom", schemaPath: "#/definitions/priceCoin/properties/denom/pattern", keyword: "pattern", params: { pattern: "^(uve|ibc/.*)$" }, message: 'must match pattern "^(uve|ibc/.*)$"' };
                              if (vErrors === null) {
                                vErrors = [err83];
                              } else {
                                vErrors.push(err83);
