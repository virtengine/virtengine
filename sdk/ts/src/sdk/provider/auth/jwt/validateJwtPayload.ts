    ...
    if (data.iss !== void 0) {
      ...
      if (typeof data8 === "string") {
        if (!pattern0.test(data8)) {
          const err20 = { instancePath: instancePath + "/iss", schemaPath: "#/properties/iss/pattern", keyword: "pattern", params: { pattern: "^ve1[a-z0-9]{38}$" }, message: 'must match pattern "^ve1[a-z0-9]{38}$"' };
          if (vErrors === null) {
            vErrors = [err20];
          } else {
            vErrors.push(err20);
                ...
                if (data27.provider !== void 0) {
                  ...
                  if (typeof data36 === "string") {
                    if (!pattern0.test(data36)) {
                      const err72 = { instancePath: instancePath + "/leases/permissions/" + i2 + "/provider", schemaPath: "#/properties/leases/properties/permissions/items/properties/provider/pattern", keyword: "pattern", params: { pattern: "^ve1[a-z0-9]{38}$" }, message: 'must match pattern "^ve1[a-z0-9]{38}$"' };
                      if (vErrors === null) {
                        vErrors = [err72];
                      } else {
                        vErrors.push(err72);
