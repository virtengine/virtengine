...
export { Locality, ResourceCapacity, ResourceInventory, ResourceRequest, ResourceAllocation, AllocationEvent, SlashingEvent, Params as Resources_Params, ResourceClass, AllocationState as Resources_AllocationState } from "./virtengine/resources/v1/types.ts";
export { GenesisState as Resources_GenesisState } from "./virtengine/resources/v1/genesis.ts";
export { QueryAvailableResourcesRequest, AvailableResource, QueryAvailableResourcesResponse, QueryAllocationRequest, QueryAllocationResponse, QueryAllocationHistoryRequest, QueryAllocationHistoryResponse, QueryAllocationsByProviderRequest as Resources_QueryAllocationsByProviderRequest, QueryAllocationsByProviderResponse, QueryParamsRequest as Resources_QueryParamsRequest, QueryParamsResponse as Resources_QueryParamsResponse } from "./virtengine/resources/v1/query.ts";
