...
export const ID: MessageFns<ID, "virtengine.cert.v1.ID"> = {
  $type: "virtengine.cert.v1.ID" as const,
...
export const Certificate: MessageFns<Certificate, "virtengine.cert.v1.Certificate"> = {
  $type: "virtengine.cert.v1.Certificate" as const,
