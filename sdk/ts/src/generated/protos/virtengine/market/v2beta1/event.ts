...
//   protoc               unknown
// source: virtengine/market/v2beta1/event.proto
...
export const EventOrderCreated: MessageFns<EventOrderCreated, "virtengine.market.v2beta1.EventOrderCreated"> = {
  $type: "virtengine.market.v2beta1.EventOrderCreated" as const,
...
export const EventOrderClosed: MessageFns<EventOrderClosed, "virtengine.market.v2beta1.EventOrderClosed"> = {
  $type: "virtengine.market.v2beta1.EventOrderClosed" as const,
...
function createBaseEventBidCreated(): EventBidCreated {
  return { id: undefined, prices: [] };
}

export const EventBidCreated: MessageFns<EventBidCreated, "virtengine.market.v2beta1.EventBidCreated"> = {
  $type: "virtengine.market.v2beta1.EventBidCreated" as const,
...
export const EventBidClosed: MessageFns<EventBidClosed, "virtengine.market.v2beta1.EventBidClosed"> = {
  $type: "virtengine.market.v2beta1.EventBidClosed" as const,
...
export const EventLeaseCreated: MessageFns<EventLeaseCreated, "virtengine.market.v2beta1.EventLeaseCreated"> = {
  $type: "virtengine.market.v2beta1.EventLeaseCreated" as const,
...
export const EventLeaseClosed: MessageFns<EventLeaseClosed, "virtengine.market.v2beta1.EventLeaseClosed"> = {
  $type: "virtengine.market.v2beta1.EventLeaseClosed" as const,
