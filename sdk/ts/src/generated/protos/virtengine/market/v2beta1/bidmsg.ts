...
//   protoc               unknown
// source: virtengine/market/v2beta1/bidmsg.proto
...
function createBaseMsgCreateBid(): MsgCreateBid {
  return { id: undefined, prices: [], deposit: undefined, resourcesOffer: [] };
}

export const MsgCreateBid: MessageFns<MsgCreateBid, "virtengine.market.v2beta1.MsgCreateBid"> = {
  $type: "virtengine.market.v2beta1.MsgCreateBid" as const,
...
export const MsgCreateBidResponse: MessageFns<MsgCreateBidResponse, "virtengine.market.v2beta1.MsgCreateBidResponse"> =
  {
    $type: "virtengine.market.v2beta1.MsgCreateBidResponse" as const,
...
export const MsgCloseBid: MessageFns<MsgCloseBid, "virtengine.market.v2beta1.MsgCloseBid"> = {
  $type: "virtengine.market.v2beta1.MsgCloseBid" as const,
...
export const MsgCloseBidResponse: MessageFns<MsgCloseBidResponse, "virtengine.market.v2beta1.MsgCloseBidResponse"> = {
  $type: "virtengine.market.v2beta1.MsgCloseBidResponse" as const,
