...
export const Query = {
  typeName: "virtengine.market.v1beta5.Query",
  methods: {
    orders: {
      name: "Orders",
      httpPath: "/virtengine/market/v1beta5/orders/list",
    ...
    order: {
      name: "Order",
      httpPath: "/virtengine/market/v1beta5/orders/info",
    ...
    bids: {
      name: "Bids",
      httpPath: "/virtengine/market/v1beta5/bids/list",
    ...
    bid: {
      name: "Bid",
      httpPath: "/virtengine/market/v1beta5/bids/info",
    ...
    leases: {
      name: "Leases",
      httpPath: "/virtengine/market/v1beta5/leases/list",
    ...
    lease: {
      name: "Lease",
      httpPath: "/virtengine/market/v1beta5/leases/info",
    ...
    params: {
      name: "Params",
      httpPath: "/virtengine/market/v1beta5/params",
