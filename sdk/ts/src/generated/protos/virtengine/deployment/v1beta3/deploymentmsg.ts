...
//   protoc               unknown
// source: virtengine/deployment/v1beta3/deploymentmsg.proto
...
function createBaseMsgCreateDeployment(): MsgCreateDeployment {
  return { id: undefined, groups: [], version: new Uint8Array(0), deposit: undefined, depositor: "" };
}

export const MsgCreateDeployment: MessageFns<MsgCreateDeployment, "virtengine.deployment.v1beta3.MsgCreateDeployment"> =
  {
    $type: "virtengine.deployment.v1beta3.MsgCreateDeployment" as const,
...
export const MsgCreateDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta3.MsgCreateDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta3.MsgCreateDeploymentResponse" as const,
...
> = {
  $type: "virtengine.deployment.v1beta3.MsgDepositDeployment" as const,

  encode(message: MsgDepositDeployment, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined) {
      DeploymentID.encode(message.id, writer.uint32(10).fork()).join();
    }
...
export const MsgDepositDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta3.MsgDepositDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta3.MsgDepositDeploymentResponse" as const,

  encode(_: MsgDepositDeploymentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
function createBaseMsgUpdateDeployment(): MsgUpdateDeployment {
  return { id: undefined, version: new Uint8Array(0) };
}

export const MsgUpdateDeployment: MessageFns<MsgUpdateDeployment, "virtengine.deployment.v1beta3.MsgUpdateDeployment"> =
  {
    $type: "virtengine.deployment.v1beta3.MsgUpdateDeployment" as const,
...
export const MsgUpdateDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta3.MsgUpdateDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta3.MsgUpdateDeploymentResponse" as const,
...
export const MsgCloseDeployment: MessageFns<MsgCloseDeployment, "virtengine.deployment.v1beta3.MsgCloseDeployment"> = {
  $type: "virtengine.deployment.v1beta3.MsgCloseDeployment" as const,
...
export const MsgCloseDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta3.MsgCloseDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta3.MsgCloseDeploymentResponse" as const,
