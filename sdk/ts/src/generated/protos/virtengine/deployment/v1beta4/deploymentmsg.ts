...
export const MsgCreateDeployment: MessageFns<MsgCreateDeployment, "virtengine.deployment.v1beta4.MsgCreateDeployment"> =
  {
    $type: "virtengine.deployment.v1beta4.MsgCreateDeployment" as const,
...
export const MsgCreateDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta4.MsgCreateDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta4.MsgCreateDeploymentResponse" as const,
...
export const MsgUpdateDeployment: MessageFns<MsgUpdateDeployment, "virtengine.deployment.v1beta4.MsgUpdateDeployment"> =
  {
    $type: "virtengine.deployment.v1beta4.MsgUpdateDeployment" as const,
...
export const MsgUpdateDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta4.MsgUpdateDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta4.MsgUpdateDeploymentResponse" as const,
...
export const MsgCloseDeployment: MessageFns<MsgCloseDeployment, "virtengine.deployment.v1beta4.MsgCloseDeployment"> = {
  $type: "virtengine.deployment.v1beta4.MsgCloseDeployment" as const,
...
export const MsgCloseDeploymentResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta4.MsgCloseDeploymentResponse"
> = {
  $type: "virtengine.deployment.v1beta4.MsgCloseDeploymentResponse" as const,
