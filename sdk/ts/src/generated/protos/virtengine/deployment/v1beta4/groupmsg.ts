...
export const MsgCloseGroup: MessageFns<MsgCloseGroup, "virtengine.deployment.v1beta4.MsgCloseGroup"> = {
  $type: "virtengine.deployment.v1beta4.MsgCloseGroup" as const,
...
export const MsgCloseGroupResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta4.MsgCloseGroupResponse"
> = {
  $type: "virtengine.deployment.v1beta4.MsgCloseGroupResponse" as const,
...
export const MsgPauseGroup: MessageFns<MsgPauseGroup, "virtengine.deployment.v1beta4.MsgPauseGroup"> = {
  $type: "virtengine.deployment.v1beta4.MsgPauseGroup" as const,
...
export const MsgPauseGroupResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta4.MsgPauseGroupResponse"
> = {
  $type: "virtengine.deployment.v1beta4.MsgPauseGroupResponse" as const,
...
export const MsgStartGroup: MessageFns<MsgStartGroup, "virtengine.deployment.v1beta4.MsgStartGroup"> = {
  $type: "virtengine.deployment.v1beta4.MsgStartGroup" as const,
...
export const MsgStartGroupResponse: MessageFns<
  ...
  "virtengine.deployment.v1beta4.MsgStartGroupResponse"
> = {
  $type: "virtengine.deployment.v1beta4.MsgStartGroupResponse" as const,
