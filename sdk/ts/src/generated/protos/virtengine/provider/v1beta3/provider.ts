...
export const ProviderInfo: MessageFns<ProviderInfo, "virtengine.provider.v1beta3.ProviderInfo"> = {
  $type: "virtengine.provider.v1beta3.ProviderInfo" as const,
...
export const MsgCreateProvider: MessageFns<MsgCreateProvider, "virtengine.provider.v1beta3.MsgCreateProvider"> = {
  $type: "virtengine.provider.v1beta3.MsgCreateProvider" as const,
  ...
  encode(message: MsgCreateProvider, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.info !== undefined) {
      ProviderInfo.encode(message.info, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const MsgCreateProviderResponse: MessageFns<
  ...
  "virtengine.provider.v1beta3.MsgCreateProviderResponse"
> = {
  $type: "virtengine.provider.v1beta3.MsgCreateProviderResponse" as const,
...
export const MsgUpdateProvider: MessageFns<MsgUpdateProvider, "virtengine.provider.v1beta3.MsgUpdateProvider"> = {
  $type: "virtengine.provider.v1beta3.MsgUpdateProvider" as const,
...
export const MsgUpdateProviderResponse: MessageFns<
  ...
  "virtengine.provider.v1beta3.MsgUpdateProviderResponse"
> = {
  $type: "virtengine.provider.v1beta3.MsgUpdateProviderResponse" as const,
...
export const MsgDeleteProvider: MessageFns<MsgDeleteProvider, "virtengine.provider.v1beta3.MsgDeleteProvider"> = {
  $type: "virtengine.provider.v1beta3.MsgDeleteProvider" as const,
...
export const MsgDeleteProviderResponse: MessageFns<
  ...
  "virtengine.provider.v1beta3.MsgDeleteProviderResponse"
> = {
  $type: "virtengine.provider.v1beta3.MsgDeleteProviderResponse" as const,
...
export const Provider: MessageFns<Provider, "virtengine.provider.v1beta3.Provider"> = {
  $type: "virtengine.provider.v1beta3.Provider" as const,
