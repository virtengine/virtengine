...
export const GenesisState: MessageFns<GenesisState, "virtengine.resources.v1.GenesisState"> = {
  $type: "virtengine.resources.v1.GenesisState" as const,
  ...
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.inventories) {
      ResourceInventory.encode(v!, writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.inventories.push(ResourceInventory.decode(reader, reader.uint32()));
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      inventories: globalThis.Array.isArray(object?.inventories)
        ? object.inventories.map((e: any) => ResourceInventory.fromJSON(e))
        : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.inventories?.length) {
      obj.inventories = message.inventories.map((e) => ResourceInventory.toJSON(e));
    }
