...
export interface QuerySSOLinkageRequest {
  linkageId: string;
  accountAddress: string;
  provider: string;
}
...
export interface QuerySSOLinkageResponse {
  linkage: SSOLinkageMetadata | undefined;
}
...
export interface QueryEmailVerificationResponse {
  record: EmailVerificationRecord | undefined;
}

/** QuerySMSVerificationRequest is the request type for SMS verification queries. */
export interface QuerySMSVerificationRequest {
  verificationId: string;
  accountAddress: string;
  phoneHash: string;
}
...
function createBaseQuerySSOLinkageRequest(): QuerySSOLinkageRequest {
  return { linkageId: "", accountAddress: "", provider: "" };
}

export const QuerySSOLinkageRequest: MessageFns<QuerySSOLinkageRequest, "virtengine.veid.v1.QuerySSOLinkageRequest"> = {
  $type: "virtengine.veid.v1.QuerySSOLinkageRequest" as const,

  encode(message: QuerySSOLinkageRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySSOLinkageRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySSOLinkageRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QuerySSOLinkageRequest {
    return {
  ...
  toJSON(message: QuerySSOLinkageRequest): unknown {
    const obj: any = {};
    if (message.linkageId !== "") {
  ...
  fromPartial(object: DeepPartial<QuerySSOLinkageRequest>): QuerySSOLinkageRequest {
    const message = createBaseQuerySSOLinkageRequest();
...
function createBaseQuerySSOLinkageResponse(): QuerySSOLinkageResponse {
  return { linkage: undefined };
}

export const QuerySSOLinkageResponse: MessageFns<
  QuerySSOLinkageResponse,
  "virtengine.veid.v1.QuerySSOLinkageResponse"
> = {
  $type: "virtengine.veid.v1.QuerySSOLinkageResponse" as const,

  encode(message: QuerySSOLinkageResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.linkage !== undefined) {
      SSOLinkageMetadata.encode(message.linkage, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QuerySSOLinkageResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySSOLinkageResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.linkage = SSOLinkageMetadata.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuerySSOLinkageResponse {
    return { linkage: isSet(object.linkage) ? SSOLinkageMetadata.fromJSON(object.linkage) : undefined };
  },

  toJSON(message: QuerySSOLinkageResponse): unknown {
    const obj: any = {};
    if (message.linkage !== undefined) {
      obj.linkage = SSOLinkageMetadata.toJSON(message.linkage);
    }
    return obj;
  },
  fromPartial(object: DeepPartial<QuerySSOLinkageResponse>): QuerySSOLinkageResponse {
    const message = createBaseQuerySSOLinkageResponse();
    message.linkage = (object.linkage !== undefined && object.linkage !== null)
      ? SSOLinkageMetadata.fromPartial(object.linkage)
      : undefined;
    return message;
  },
};

function createBaseQueryEmailVerificationRequest(): QueryEmailVerificationRequest {
  return { verificationId: "", accountAddress: "", emailHash: "" };
}

export const QueryEmailVerificationRequest: MessageFns<
  QueryEmailVerificationRequest,
  "virtengine.veid.v1.QueryEmailVerificationRequest"
> = {
  $type: "virtengine.veid.v1.QueryEmailVerificationRequest" as const,

  encode(message: QueryEmailVerificationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEmailVerificationRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryEmailVerificationRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryEmailVerificationRequest {
    return {
  ...
  toJSON(message: QueryEmailVerificationRequest): unknown {
    const obj: any = {};
    if (message.verificationId !== "") {
  ...
  fromPartial(object: DeepPartial<QueryEmailVerificationRequest>): QueryEmailVerificationRequest {
    const message = createBaseQueryEmailVerificationRequest();
...
function createBaseQueryEmailVerificationResponse(): QueryEmailVerificationResponse {
  return { record: undefined };
}

export const QueryEmailVerificationResponse: MessageFns<
  QueryEmailVerificationResponse,
  "virtengine.veid.v1.QueryEmailVerificationResponse"
> = {
  $type: "virtengine.veid.v1.QueryEmailVerificationResponse" as const,

  encode(message: QueryEmailVerificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.record !== undefined) {
      EmailVerificationRecord.encode(message.record, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryEmailVerificationResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryEmailVerificationResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.record = EmailVerificationRecord.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QueryEmailVerificationResponse {
    return { record: isSet(object.record) ? EmailVerificationRecord.fromJSON(object.record) : undefined };
  },

  toJSON(message: QueryEmailVerificationResponse): unknown {
    const obj: any = {};
    if (message.record !== undefined) {
      obj.record = EmailVerificationRecord.toJSON(message.record);
    }
    return obj;
  },
  fromPartial(object: DeepPartial<QueryEmailVerificationResponse>): QueryEmailVerificationResponse {
    const message = createBaseQueryEmailVerificationResponse();
    message.record = (object.record !== undefined && object.record !== null)
      ? EmailVerificationRecord.fromPartial(object.record)
      : undefined;
    return message;
  },
};

function createBaseQuerySMSVerificationRequest(): QuerySMSVerificationRequest {
  return { verificationId: "", accountAddress: "", phoneHash: "" };
}

export const QuerySMSVerificationRequest: MessageFns<
  QuerySMSVerificationRequest,
  "virtengine.veid.v1.QuerySMSVerificationRequest"
> = {
  $type: "virtengine.veid.v1.QuerySMSVerificationRequest" as const,

  encode(message: QuerySMSVerificationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.verificationId !== "") {
      writer.uint32(10).string(message.verificationId);
    }
    if (message.accountAddress !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySMSVerificationRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySMSVerificationRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QuerySMSVerificationRequest {
    return {
      verificationId: isSet(object.verification_id) ? globalThis.String(object.verification_id) : "",
      accountAddress: isSet(object.account_address) ? globalThis.String(object.account_address) : "",
  ...
  toJSON(message: QuerySMSVerificationRequest): unknown {
    const obj: any = {};
    if (message.verificationId !== "") {
      obj.verification_id = message.verificationId;
    }
  ...
  fromPartial(object: DeepPartial<QuerySMSVerificationRequest>): QuerySMSVerificationRequest {
    const message = createBaseQuerySMSVerificationRequest();
    message.verificationId = object.verificationId ?? "";
    message.accountAddress = object.accountAddress ?? "";
...
function createBaseQuerySMSVerificationResponse(): QuerySMSVerificationResponse {
  return { record: undefined };
}

export const QuerySMSVerificationResponse: MessageFns<
  QuerySMSVerificationResponse,
  "virtengine.veid.v1.QuerySMSVerificationResponse"
> = {
  $type: "virtengine.veid.v1.QuerySMSVerificationResponse" as const,

  encode(message: QuerySMSVerificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.record !== undefined) {
      SMSVerificationRecord.encode(message.record, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QuerySMSVerificationResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySMSVerificationResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.record = SMSVerificationRecord.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuerySMSVerificationResponse {
    return { record: isSet(object.record) ? SMSVerificationRecord.fromJSON(object.record) : undefined };
  },

  toJSON(message: QuerySMSVerificationResponse): unknown {
    const obj: any = {};
    if (message.record !== undefined) {
      obj.record = SMSVerificationRecord.toJSON(message.record);
    }
    return obj;
  },
  fromPartial(object: DeepPartial<QuerySMSVerificationResponse>): QuerySMSVerificationResponse {
    const message = createBaseQuerySMSVerificationResponse();
    message.record = (object.record !== undefined && object.record !== null)
      ? SMSVerificationRecord.fromPartial(object.record)
      : undefined;
    return message;
  },
};

function createBaseQuerySocialMediaScopeRequest(): QuerySocialMediaScopeRequest {
  return { scopeId: "", accountAddress: "" };
}

export const QuerySocialMediaScopeRequest: MessageFns<
  QuerySocialMediaScopeRequest,
  "virtengine.veid.v1.QuerySocialMediaScopeRequest"
> = {
  $type: "virtengine.veid.v1.QuerySocialMediaScopeRequest" as const,

  encode(message: QuerySocialMediaScopeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.scopeId !== "") {
      writer.uint32(10).string(message.scopeId);
    }
    if (message.accountAddress !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySocialMediaScopeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySocialMediaScopeRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QuerySocialMediaScopeRequest {
    return {
      scopeId: isSet(object.scope_id) ? globalThis.String(object.scope_id) : "",
      accountAddress: isSet(object.account_address) ? globalThis.String(object.account_address) : "",
    };
  ...
  toJSON(message: QuerySocialMediaScopeRequest): unknown {
    const obj: any = {};
    if (message.scopeId !== "") {
      obj.scope_id = message.scopeId;
    }
  ...
  fromPartial(object: DeepPartial<QuerySocialMediaScopeRequest>): QuerySocialMediaScopeRequest {
    const message = createBaseQuerySocialMediaScopeRequest();
    message.scopeId = object.scopeId ?? "";
    message.accountAddress = object.accountAddress ?? "";
    return message;
...
function createBaseQuerySocialMediaScopeResponse(): QuerySocialMediaScopeResponse {
  return { scope: undefined };
}

export const QuerySocialMediaScopeResponse: MessageFns<
  QuerySocialMediaScopeResponse,
  "virtengine.veid.v1.QuerySocialMediaScopeResponse"
> = {
  $type: "virtengine.veid.v1.QuerySocialMediaScopeResponse" as const,

  encode(message: QuerySocialMediaScopeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.scope !== undefined) {
      SocialMediaScope.encode(message.scope, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QuerySocialMediaScopeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySocialMediaScopeResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.scope = SocialMediaScope.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuerySocialMediaScopeResponse {
    return { scope: isSet(object.scope) ? SocialMediaScope.fromJSON(object.scope) : undefined };
  },

  toJSON(message: QuerySocialMediaScopeResponse): unknown {
    const obj: any = {};
    if (message.scope !== undefined) {
      obj.scope = SocialMediaScope.toJSON(message.scope);
    }
    return obj;
  },
  fromPartial(object: DeepPartial<QuerySocialMediaScopeResponse>): QuerySocialMediaScopeResponse {
    const message = createBaseQuerySocialMediaScopeResponse();
    message.scope = (object.scope !== undefined && object.scope !== null)
      ? SocialMediaScope.fromPartial(object.scope)
      : undefined;
    return message;
  },
};

function createBaseQuerySocialMediaScopesRequest(): QuerySocialMediaScopesRequest {
  return { accountAddress: "", provider: "" };
}

export const QuerySocialMediaScopesRequest: MessageFns<
  QuerySocialMediaScopesRequest,
  "virtengine.veid.v1.QuerySocialMediaScopesRequest"
> = {
  $type: "virtengine.veid.v1.QuerySocialMediaScopesRequest" as const,

  encode(message: QuerySocialMediaScopesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.accountAddress !== "") {
      writer.uint32(10).string(message.accountAddress);
    }
    if (message.provider !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySocialMediaScopesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySocialMediaScopesRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QuerySocialMediaScopesRequest {
    return {
      accountAddress: isSet(object.account_address) ? globalThis.String(object.account_address) : "",
      provider: isSet(object.provider) ? globalThis.String(object.provider) : "",
    };
  ...
  toJSON(message: QuerySocialMediaScopesRequest): unknown {
    const obj: any = {};
    if (message.accountAddress !== "") {
      obj.account_address = message.accountAddress;
    }
  ...
  fromPartial(object: DeepPartial<QuerySocialMediaScopesRequest>): QuerySocialMediaScopesRequest {
    const message = createBaseQuerySocialMediaScopesRequest();
    message.accountAddress = object.accountAddress ?? "";
    message.provider = object.provider ?? "";
    return message;
...
function createBaseQuerySocialMediaScopesResponse(): QuerySocialMediaScopesResponse {
  return { scopes: [] };
}

export const QuerySocialMediaScopesResponse: MessageFns<
  QuerySocialMediaScopesResponse,
  "virtengine.veid.v1.QuerySocialMediaScopesResponse"
> = {
  $type: "virtengine.veid.v1.QuerySocialMediaScopesResponse" as const,

  encode(message: QuerySocialMediaScopesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.scopes) {
      SocialMediaScope.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QuerySocialMediaScopesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySocialMediaScopesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.scopes.push(SocialMediaScope.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuerySocialMediaScopesResponse {
    return {
      scopes: globalThis.Array.isArray(object?.scopes)
        ? object.scopes.map((e: any) => SocialMediaScope.fromJSON(e))
        : [],
    };
  },

  toJSON(message: QuerySocialMediaScopesResponse): unknown {
    const obj: any = {};
    if (message.scopes?.length) {
      obj.scopes = message.scopes.map((e) => SocialMediaScope.toJSON(e));
    }
    return obj;
  },
  fromPartial(object: DeepPartial<QuerySocialMediaScopesResponse>): QuerySocialMediaScopesResponse {
    const message = createBaseQuerySocialMediaScopesResponse();
    message.scopes = object.scopes?.map((e) => SocialMediaScope.fromPartial(e)) || [];
    return message;
  },
};
