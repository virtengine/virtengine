...
export const Query = {
  ...
  methods: {
    constitution: {
      name: "Constitution",
      httpPath: "/cosmos/gov/v1/constitution",
      input: QueryConstitutionRequest,
      output: QueryConstitutionResponse,
      get parent() { return Query; },
    },
    proposal: {
      name: "Proposal",
      httpPath: "/cosmos/gov/v1/proposals/{proposal_id}",
    ...
    proposals: {
      name: "Proposals",
      httpPath: "/cosmos/gov/v1/proposals",
    ...
    vote: {
      name: "Vote",
      httpPath: "/cosmos/gov/v1/proposals/{proposal_id}/votes/{voter}",
    ...
    votes: {
      name: "Votes",
      httpPath: "/cosmos/gov/v1/proposals/{proposal_id}/votes",
    ...
    params: {
      name: "Params",
      httpPath: "/cosmos/gov/v1/params/{params_type}",
    ...
    deposit: {
      name: "Deposit",
      httpPath: "/cosmos/gov/v1/proposals/{proposal_id}/deposits/{depositor}",
    ...
    deposits: {
      name: "Deposits",
      httpPath: "/cosmos/gov/v1/proposals/{proposal_id}/deposits",
    ...
    tallyResult: {
      name: "TallyResult",
      httpPath: "/cosmos/gov/v1/proposals/{proposal_id}/tally",
