...
export const Proof: MessageFns<Proof, "cometbft.crypto.v1.Proof"> = {
  $type: "cometbft.crypto.v1.Proof" as const,
...
export const ValueOp: MessageFns<ValueOp, "cometbft.crypto.v1.ValueOp"> = {
  $type: "cometbft.crypto.v1.ValueOp" as const,
...
export const DominoOp: MessageFns<DominoOp, "cometbft.crypto.v1.DominoOp"> = {
  $type: "cometbft.crypto.v1.DominoOp" as const,
...
export const ProofOp: MessageFns<ProofOp, "cometbft.crypto.v1.ProofOp"> = {
  $type: "cometbft.crypto.v1.ProofOp" as const,
...
export const ProofOps: MessageFns<ProofOps, "cometbft.crypto.v1.ProofOps"> = {
  $type: "cometbft.crypto.v1.ProofOps" as const,
