...
import { Proof } from "../../crypto/v1/proof.ts";
import { Consensus } from "../../version/v1/types.ts";
...
export const PartSetHeader: MessageFns<PartSetHeader, "cometbft.types.v2.PartSetHeader"> = {
  $type: "cometbft.types.v2.PartSetHeader" as const,
...
export const Part: MessageFns<Part, "cometbft.types.v2.Part"> = {
  $type: "cometbft.types.v2.Part" as const,
...
export const BlockID: MessageFns<BlockID, "cometbft.types.v2.BlockID"> = {
  $type: "cometbft.types.v2.BlockID" as const,
...
export const Header: MessageFns<Header, "cometbft.types.v2.Header"> = {
  $type: "cometbft.types.v2.Header" as const,
...
export const Data: MessageFns<Data, "cometbft.types.v2.Data"> = {
  $type: "cometbft.types.v2.Data" as const,
...
export const Vote: MessageFns<Vote, "cometbft.types.v2.Vote"> = {
  $type: "cometbft.types.v2.Vote" as const,
...
export const Commit: MessageFns<Commit, "cometbft.types.v2.Commit"> = {
  $type: "cometbft.types.v2.Commit" as const,
...
export const CommitSig: MessageFns<CommitSig, "cometbft.types.v2.CommitSig"> = {
  $type: "cometbft.types.v2.CommitSig" as const,
...
export const ExtendedCommit: MessageFns<ExtendedCommit, "cometbft.types.v2.ExtendedCommit"> = {
  $type: "cometbft.types.v2.ExtendedCommit" as const,
...
export const ExtendedCommitSig: MessageFns<ExtendedCommitSig, "cometbft.types.v2.ExtendedCommitSig"> = {
  $type: "cometbft.types.v2.ExtendedCommitSig" as const,
...
export const Proposal: MessageFns<Proposal, "cometbft.types.v2.Proposal"> = {
  $type: "cometbft.types.v2.Proposal" as const,
...
export const SignedHeader: MessageFns<SignedHeader, "cometbft.types.v2.SignedHeader"> = {
  $type: "cometbft.types.v2.SignedHeader" as const,
...
export const LightBlock: MessageFns<LightBlock, "cometbft.types.v2.LightBlock"> = {
  $type: "cometbft.types.v2.LightBlock" as const,
...
export const BlockMeta: MessageFns<BlockMeta, "cometbft.types.v2.BlockMeta"> = {
  $type: "cometbft.types.v2.BlockMeta" as const,
...
export const TxProof: MessageFns<TxProof, "cometbft.types.v2.TxProof"> = {
  $type: "cometbft.types.v2.TxProof" as const,
