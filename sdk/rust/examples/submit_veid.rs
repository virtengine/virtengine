...
use virtengine_sdk::proto::virtengine::veid::v1::MsgSubmitScope;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let msg = MsgSubmitScope {
        scope_type: 1,
        encrypted_data: b"...".to_vec(),
        client_sig: b"...".to_vec(),
        envelope: None,
    };
    let msg_any = pack_any(&msg, "/virtengine.veid.v1.MsgSubmitScope")?;
    let response = client
