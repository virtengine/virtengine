...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.bme.v1.Query", "Params"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.bme.v1.Query", "VaultState"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn status(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.bme.v1.Query", "Status"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "virtengine.bme.v1.Query";
    }
}
/// Generated client implementations.
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.bme.v1.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
...
*/
    ...
    impl<T: Msg> tonic::server::NamedService for MsgServer<T> {
        const NAME: &'static str = "virtengine.bme.v1.Msg";
    }
}
