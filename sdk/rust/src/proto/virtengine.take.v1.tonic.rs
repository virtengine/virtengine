...
*/
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/virtengine.take.v1.Query/Params",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.take.v1.Query", "Params"));
...
*/
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "virtengine.take.v1.Query";
    }
}
/// Generated client implementations.
pub mod msg_client {
...
*/
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/virtengine.take.v1.Msg/UpdateParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.take.v1.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
    ...
    impl<T: Msg> tonic::server::NamedService for MsgServer<T> {
        const NAME: &'static str = "virtengine.take.v1.Msg";
    }
}
