...
impl serde::Serialize for App {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.version.v1.App", len)?;
        if self.protocol != 0 {
...
impl<'de> serde::Deserialize<'de> for App {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.version.v1.App")
            }
        ...
        deserializer.deserialize_struct("cometbft.version.v1.App", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Consensus {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.version.v1.Consensus", len)?;
        if self.block != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for Consensus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.version.v1.Consensus")
            }
        ...
        deserializer.deserialize_struct("cometbft.version.v1.Consensus", FIELDS, GeneratedVisitor)
    }
}
