...
impl serde::Serialize for SearchBlocksResult {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmos.base.abci.v1beta1.SearchBlocksResult", len)?;
        if self.total_count != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for SearchBlocksResult {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.base.abci.v1beta1.SearchBlocksResult", FIELDS, GeneratedVisitor)
    }
}
