...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.oracle.v1.Query", "Prices"));
...
*/
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.oracle.v1.Query", "Params"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("virtengine.oracle.v1.Query", "PriceFeedConfig"),
                );
            self.inner.unary(req, path, codec).await
        }
...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("virtengine.oracle.v1.Query", "AggregatedPrice"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
*/
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "virtengine.oracle.v1.Query";
    }
}
/// Generated client implementations.
pub mod msg_client {
...
*/
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.oracle.v1.Msg", "AddPriceEntry"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("virtengine.oracle.v1.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
    ...
    impl<T: Msg> tonic::server::NamedService for MsgServer<T> {
        const NAME: &'static str = "virtengine.oracle.v1.Msg";
    }
}
