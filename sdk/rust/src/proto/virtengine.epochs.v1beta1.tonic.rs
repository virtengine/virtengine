...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("virtengine.epochs.v1beta1.Query", "EpochInfos"),
                );
...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("virtengine.epochs.v1beta1.Query", "CurrentEpoch"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
*/
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "virtengine.epochs.v1beta1.Query";
    }
}
