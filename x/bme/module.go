...
// ValidateGenesis performs genesis state validation for the bme module.
...
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, mux *runtime.ServeMux) {
	...
	if err != nil {
		panic(fmt.Sprintf("couldn't register bme grpc routes: %s", err.Error()))
	}
}
...
// Name returns the bme module name
...
// InitGenesis performs genesis initialization for the bme module.
...
// ExportGenesis returns the exported genesis state as raw bytes for the bme module.
