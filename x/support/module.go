...
// AppModuleBasic defines the basic application module used by the support module.
type AppModuleBasic struct {
	cdc codec.Codec
}

// Name returns the support module's name
func (AppModuleBasic) Name() string {
	return types.ModuleName
}

// RegisterLegacyAminoCodec registers the support module's types for the given codec.
...
// ValidateGenesis performs genesis state validation for the support module.
...
// AppModule implements an application module for the support module.
...
// Name returns the support module name
...
// QuerierRoute returns the support module's querier route name.
...
// GenerateGenesisState creates a randomized GenState of the support module.
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	// Simulation genesis state generation would go here
}

// RegisterStoreDecoder registers a decoder for support module's types
func (am AppModule) RegisterStoreDecoder(sdr simtypes.StoreDecoderRegistry) {
	// Store decoder registration would go here
}

// WeightedOperations returns the all the support module operations with their respective weights.
