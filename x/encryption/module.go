...
// Name returns the encryption module's name
func (AppModuleBasic) Name() string {
	return types.ModuleName
}

// RegisterLegacyAminoCodec registers the encryption module's types for the given codec.
...
// RegisterGRPCGatewayRoutes registers the gRPC Gateway routes for the encryption module.
...
// RegisterGRPCRoutes registers the gRPC Gateway routes for the encryption module.
...
// AppModule implements an application module for the encryption module.
...
// Name returns the encryption module name
...
// QuerierRoute returns the encryption module's querier route name.
...
// GenerateGenesisState creates a randomized GenState of the encryption module.
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	// Simulation genesis state generation would go here
}

// RegisterStoreDecoder registers a decoder for encryption module's types
func (am AppModule) RegisterStoreDecoder(sdr simtypes.StoreDecoderRegistry) {
	// Store decoder registration would go here
}

// WeightedOperations returns the all the encryption module operations with their respective weights.
