...
func FraudReportToProto(r *FraudReport) *FraudReportPB {
	...
	pb := &FraudReportPB{
		...
		FinancialCaseId:     r.FinancialCaseID,
		FinancialCaseStatus: r.FinancialCaseStatus,
	}
...
func FraudReportFromProto(pb *FraudReportPB) *FraudReport {
	...
	r := &FraudReport{
		...
		FinancialCaseID:     pb.FinancialCaseId,
		FinancialCaseStatus: pb.FinancialCaseStatus,
	}
