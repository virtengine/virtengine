...
func readAttributes(cmd *cobra.Command, cctx client.Context, provider string, args []string) (virtenginetypes.Attributes, error) {
...
func checkAttributeDuplicates(attr virtenginetypes.Attributes) bool {
