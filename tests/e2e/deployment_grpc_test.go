...
func (s *deploymentGRPCRestTestSuite) TestGetDeployments() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/%s/deployments/list", val.APIAddress, v1beta4.GatewayVersion),
			false,
			deployment,
			1,
		},
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/%s/deployments/list?filters.owner=%s", val.APIAddress,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/%s/deployments/list?filters.state=%s", val.APIAddress, v1beta4.GatewayVersion,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/%s/deployments/list?filters.state=%s&filters.dseq=%d",
...
func (s *deploymentGRPCRestTestSuite) TestGetDeployment() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/deployments/info", val.APIAddress),
			true,
			v1beta4.QueryDeploymentResponse{},
		},
		{
			"get deployment with invalid input",
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/deployments/info?id.owner=%s", val.APIAddress,
				deployment.Deployment.ID.Owner),
			true,
			v1beta4.QueryDeploymentResponse{},
		},
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/deployments/info?id.owner=%s&id.dseq=%d", val.APIAddress,
				deployment.Deployment.ID.Owner,
				249),
			true,
			v1beta4.QueryDeploymentResponse{},
		},
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/deployments/info?id.owner=%s&id.dseq=%d",
				val.APIAddress,
				deployment.Deployment.ID.Owner,
...
func (s *deploymentGRPCRestTestSuite) TestGetGroup() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/groups/info", val.APIAddress),
			true,
			v1beta4.Group{},
		},
		{
			"get group with invalid input",
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/groups/info?id.owner=%s", val.APIAddress,
				group.ID.Owner),
			true,
			v1beta4.Group{},
		},
		{
			"group not found",
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/groups/info?id.owner=%s&id.dseq=%d", val.APIAddress,
				group.ID.Owner,
				249),
			true,
			v1beta4.Group{},
		},
		{
			...
			fmt.Sprintf("%s/virtengine/deployment/v1beta4/groups/info?id.owner=%s&id.dseq=%d&id.gseq=%d",
				val.APIAddress,
				group.ID.Owner,
				group.ID.DSeq,
				group.ID.GSeq),
