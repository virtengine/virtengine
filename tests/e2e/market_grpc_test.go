...
func (s *marketGRPCRestTestSuite) TestGetOrders() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/orders/list", val.APIAddress, v1beta5.GatewayVersion),
			false,
			order,
			1,
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/orders/list?filters.owner=%s", val.APIAddress,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/orders/list?filters.state=%s", val.APIAddress,
				v1beta5.GatewayVersion,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/orders/list?filters.state=%s&filters.oseq=%d",
...
func (s *marketGRPCRestTestSuite) TestGetOrder() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/orders/info", val.APIAddress, v1beta5.GatewayVersion),
			true,
			v1beta5.Order{},
		},
		{
			"get order with invalid input",
			fmt.Sprintf("%s/virtengine/market/%s/orders/info?id.owner=%s", val.APIAddress,
				v1beta5.GatewayVersion,
				order.ID.Owner),
			true,
			v1beta5.Order{},
		...
		{
			"order not found",
			fmt.Sprintf("%s/virtengine/market/%s/orders/info?id.owner=%s&id.dseq=%d&id.gseq=%d&id.oseq=%d",
				val.APIAddress,
				v1beta5.GatewayVersion,
...
func (s *marketGRPCRestTestSuite) TestGetBids() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/bids/list", val.APIAddress, v1beta5.GatewayVersion),
			false,
			bid,
			1,
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/bids/list?filters.owner=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				bid.ID.Owner),
			false,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/bids/list?filters.state=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/bids/list?filters.state=%s&filters.oseq=%d&filters.provider=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				bid.State.String(),
				bid.ID.OSeq,
...
func (s *marketGRPCRestTestSuite) TestGetBid() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/bids/info", val.APIAddress, v1beta5.GatewayVersion),
			true,
			v1beta5.Bid{},
		},
		{
			"get bid with invalid input",
			fmt.Sprintf("%s/virtengine/market/%s/bids/info?id.owner=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				bid.ID.Owner),
			true,
		...
		{
			"bid not found",
			fmt.Sprintf("%s/virtengine/market/%s/bids/info?id.owner=%s&id.dseq=%d&id.gseq=%d&id.oseq=%d&id.provider=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				bid.ID.Provider,
				249,
...
func (s *marketGRPCRestTestSuite) TestGetLeases() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/leases/list", val.APIAddress, v1beta5.GatewayVersion),
			false,
			lease,
			1,
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/leases/list?filters.owner=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				lease.ID.Owner),
			false,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/leases/list?filters.state=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
		...
		},
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/leases/list?filters.state=%s&filters.oseq=%d&filters.provider=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				lease.State.String(),
				lease.ID.OSeq,
...
func (s *marketGRPCRestTestSuite) TestGetLease() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/virtengine/market/%s/leases/info", val.APIAddress, v1beta5.GatewayVersion),
			true,
			v1.Lease{},
		},
		{
			"get lease with invalid input",
			fmt.Sprintf("%s/virtengine/market/%s/leases/info?id.owner=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				lease.ID.Owner),
			true,
		...
		{
			"lease not found",
			fmt.Sprintf("%s/virtengine/market/%s/leases/info?id.owner=%s&id.dseq=%d&id.gseq=%d&id.oseq=%d&id.provider=%s",
				val.APIAddress,
				v1beta5.GatewayVersion,
				lease.ID.Provider,
				249,
