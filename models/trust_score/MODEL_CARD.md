...
| Version | Release Evidence | Hash Source | Notes |
|---------|------------------|-------------|-------|
| v1.0.0 | Generated by `_build/build-veid-pipeline.sh` as `release_manifest.json`, `source_provenance.json`, and `model_signature.json` for the versioned bundle | `MODEL_HASH.txt`, `release_manifest.json.sha256`, `bundle_checksums.txt`, and `bundle_checksums.txt.sha256` | Initial production bundle contract |
