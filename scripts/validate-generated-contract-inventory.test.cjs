...
const validate = (value, options = {}) => validateGeneratedContractInventory(value, { rootDir: root, requireReady: options.requireReady, verifyAcceptedProducer: options.verifyAcceptedProducer });
