...
kubetypes: $(K8S_GENERATE_GROUPS)
	GOBIN=$(VIRTENGINE_DEVCACHE_BIN) $(K8S_GENERATE_GROUPS) all \
	github.com/virtengine/virtengine/pkg/client github.com/virtengine/virtengine/pkg/apis \
	virtengine.network:v1
