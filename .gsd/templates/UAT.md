...
Template for `.gsd/phases/XX-name/{phase}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /plan-phase.md --gaps
...
5. status → "diagnosed"
6. Ready for /plan-phase.md --gaps with root causes
...
**Creation:** When /verify-work.md starts new session
