...
Template for `.gsd/REQUIREMENTS.md` — checkable requirements that define "done."
...
_Requirements defined: 2025-01-14_
_Last updated: 2025-01-14 after initial definition_
```
