...
Template for `.gsd/phases/XX-name/{phase}-CONTEXT.md` - captures implementation decisions for a phase.
...
- File lives in phase directory: `.gsd/phases/XX-name/{phase}-CONTEXT.md`
