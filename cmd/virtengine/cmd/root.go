...
import (
	...
	"github.com/virtengine/virtengine/cmd/virtengine/cmd/access"
...
func NewRootCmd() (*cobra.Command, sdkutil.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		Long:              "VirtEngine CLI Utility.\n\nVirtEngine is a peer-to-peer marketplace for computing resources and \na deployment platform for heavily distributed applications. \nFind out more at https://virtengine.com",
		SilenceUsage:      true,
		PersistentPreRunE: cli.GetPersistentPreRunE(encodingConfig, []string{"VE"}, cli.DefaultHome),
	}
