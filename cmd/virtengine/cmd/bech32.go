...
// ConvertBech32Cmd get cmd to convert any bech32 address to an virtengine prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the virtengine prefix",
		Long: `Convert any bech32 string to the virtengine prefix
Especially useful for converting cosmos addresses to virtengine addresses
Example:
	virtengine bech32-convert virtengine1ey69r37gfxvxg62sh4r0ktpuc46pzjrmz29g45
	`,
