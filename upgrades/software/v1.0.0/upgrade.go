...
// VirtEngineUtilsExtraAccountTypes is a map of extra account types that can be overridden.
// This is defined as a global variable, so it can be modified in the chain's app.go and used here without
// having to import the chain. Specifically, this is used for compatibility with virtengine' Cosmos SDK fork
var VirtEngineUtilsExtraAccountTypes map[reflect.Type]struct{}
...
func CanCreateModuleAccountAtAddr(ctx sdk.Context, ak AccountKeeper, addr sdk.AccAddress) error {
	...
	for extraAccountType := range VirtEngineUtilsExtraAccountTypes {
...
func (up *upgrade) UpgradeHandler() upgradetypes.UpgradeHandler {
	...
	return func(ctx context.Context, plan upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
		...
		err = up.Keepers.VirtEngine.Take.SetParams(sctx, tparams)
		if err != nil {
			return nil, err
		}
		...
		err = up.Keepers.VirtEngine.Deployment.SetParams(sctx, nDeplParams)
		if err != nil {
			return nil, err
		}
		...
		err = up.Keepers.VirtEngine.Market.SetParams(sctx, mv1beta.Params{
...
func (up *upgrade) patchDepositAuthorizations(ctx sdk.Context) error {
	msgUrlOld := "/virtengine.deployment.v1beta3.MsgDepositDeployment"
